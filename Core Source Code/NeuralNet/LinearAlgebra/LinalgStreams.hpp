...
namespace Linalg{
    ...
    class RowStream{
        ...
        void getValues(FlatArray<NumberType>& return_address){
            ...
            for(; idx + 7 < end; idx += 8){
                ...
                rtn[idx]     = data[base];
                rtn[idx + 1] = data[base + 1];
                rtn[idx + 2] = data[base + 2];
                rtn[idx + 3] = data[base + 3];
                rtn[idx + 4] = data[base + 4];
                rtn[idx + 5] = data[base + 5];
                rtn[idx + 6] = data[base + 6];
                rtn[idx + 7] = data[base + 7];
            }
            for(; idx < end; idx++)   
            rtn[idx]     = data[idx + start];
      ...
      )
    {
        ...
        std::size_t idx = 0;
        for(; idx + 7 < s1.getNumItems(); idx += 8){
