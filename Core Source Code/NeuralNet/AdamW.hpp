...
public:
  ...
  update(std::pair<Linalg::Matrix<MatTy1> &, Linalg::Matrix<MatTy2> &> mats,
    ...
    Linalg::zip_no_accum(buff_ref->momentum_buff, mats.second, buff_ref->momentum_buff, momentum_updater,
                         Linalg::Indexers::defaultIndexer,
                         Linalg::Indexers::defaultIndexer);
    Linalg::zip_no_accum(buff_ref->velocity_buff, mats.second, buff_ref->velocity_buff, velocity_updater,
                         Linalg::Indexers::defaultIndexer,
                         Linalg::Indexers::defaultIndexer);
